...
//     // Verify other companies (ABC Company) get null pricing fields for XYZ's company-specific package
...
//       quantity: 1,
//     });
//     console.log("ABC Company pricing for Machine Parts (expected nulls):", abcPricingResult);
//     console.assert(abcPricingResult.transportRate === null, "Transport rate should be null");
//     console.assert(abcPricingResult.pickupCharge === null, "Pickup charge should be null");
//     console.assert(abcPricingResult.deliveryCharge === null, "Delivery charge should be null");
//     console.assert(abcPricingResult.totalAmount === null, "Total amount should be null");
...
//     console.assert(test4Result.transportRate === null, "Transport rate should be null");
//     console.assert(test4Result.pickupCharge === null, "Pickup charge should be null");
//     console.assert(test4Result.deliveryCharge === null, "Delivery charge should be null");
//     console.assert(test4Result.pricePerPiece === null, "Price per piece should be null");
//     console.assert(test4Result.totalAmount === null, "Total amount should be null");
...
//     console.assert(createdShipmentUnconfigured.transportRate === null, "Transport rate should be null");
//     console.assert(createdShipmentUnconfigured.pickupCharge === null, "Pickup charge should be null");
//     console.assert(createdShipmentUnconfigured.deliveryCharge === null, "Delivery charge should be null");
//     console.assert(createdShipmentUnconfigured.pricePerPiece === null, "Price per piece should be null");
//     console.assert(createdShipmentUnconfigured.totalAmount === null, "Total amount should be null");
