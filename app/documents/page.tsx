        ...
        <div className="bg-slate-905 border border-slate-800 p-5 rounded-2xl flex flex-col gap-4 shadow-lg backdrop-blur-md">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 text-xs text-slate-200 rounded-xl px-4 py-2.5 outline-none cursor-pointer focus:border-violet-500 focus:ring-1 focus:ring-violet-500 appearance-none shadow-md"
            >
