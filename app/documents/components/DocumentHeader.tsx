...
export default function DocumentHeader({
  ...
  return (
    <div className="border-b-2 border-slate-900 pb-6 mb-8 flex flex-col gap-6">
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-650 mt-1 font-medium leading-relaxed max-w-md">
            {branding.address}
          </p>
          <div className="text-[10px] text-slate-500 font-semibold mt-1.5 flex flex-col gap-0.5">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 border-t border-slate-100 pt-4">
        <div>
          <span className="text-[10px] font-bold uppercase tracking-widest text-violet-600 mb-0.5 block">
            Official Document
          </span>
        ...
        <div className="text-right text-[10px] text-slate-500 font-bold flex flex-col gap-0.5 items-end">
